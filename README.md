...
$$
x = \omega_x, \quad y = \omega_y, \quad z = \omega_z
$$

and

$$
a = 0.4, \quad b = 0.175, \quad c = 0.4.
$$

Note: The values of the inertial axes 

$$
I_x = 3, I_y = 2, I_z = 1,
$$

meaning the intermediate axis y will always be unstable.
...
- Without control: chaotic divergence under disturbance torques
 ...
 - Control Strategy
  ...
  - Time series plots
     ...
     - After control ( parameter a now reduced to the value of 0.1 )
